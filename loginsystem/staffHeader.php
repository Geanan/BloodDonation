  			...
  			<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarResponsive">
				...
				<div class="collapse navbar-collapse" id="navbarResponsive">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item">
							<a class="nav-link" href="analize.php" style="color: white">Urmarire donari</a>
						</li>
						<li class="nav-item">
						...
						<li class="nav-item">
							<a class="nav-link" href="calendar.php" style="color: white">Adimistrare donari</a>
						</li>
						<li class="nav-item">
