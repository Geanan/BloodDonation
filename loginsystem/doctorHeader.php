  			...
  			<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarResponsive">
				...
				<div class="collapse navbar-collapse" id="navbarResponsive">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item">
							<a class="nav-link" href="doctor.php" style="color: white">Home</a>
						</li>
						
						<li class="nav-item">
							<a class="nav-link" href="trimite_analize.php" style="color: white">Trimite analize</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="chestionar.php" style="color: white">Completeaza cerere</a>
						</li>
						
						<li class="nav-item">
							<a class="nav-link" href="calendar.php" style="color: white">Vizualizeaza cereri</a>
						</li>
						<li class="nav-item">
