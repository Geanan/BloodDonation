  ...
  <!-- Indicators -->
						  ...
						  <div class="carousel-inner">
						    <div class="carousel-item active">
						      <img src="img/4.jpg" style="width: 900px">
						      
						  
						    </div>
						    <div class="carousel-item">
						      <img src="img/5.jpg "  style="width: 900px">
						    </div>
						    <div class="carousel-item">
						      <img src="img/6.jpg "  style="width: 900px" >
						    </div>
						  <div class="carousel-caption" style="margin-bottom: 550px;"> 
        ...
        <div class="mx-auto col-md-10">
        	<div class="card">
						...
						<div class="card-body">
							...
							<p>
								<h4 style="color: #CE3C3C">Donarea de sange este darul vietii !</h4>
							...
							<p>
								...
								<p style="color: #CE3C3C">
								Sângele donat poate trata în fiecare an un milion de pacienti.</p>
							...
							<br>
							<h4 style="color: #CE3C3C">Plasmă</h4>
							<p>
